...
Report bugs at https://github.com/Behordeun/Python-Poetry/issues
...
https://github.com/Behordeun/Python-Poetry/issues.
...
Ready to contribute? Here's how to set up `Python-Poetry` for local
development. Please note this documentation assumes you already have
`poetry` and `Git` installed and ready to go.

| 1. Fork the `Python-Poetry` repo on GitHub. 
...
| 2. Clone your fork locally:
   ...
   .. code-block:: bash
        ...
        git clone git@github.com:YOUR_NAME/Python-Poetry.git
